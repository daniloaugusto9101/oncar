            ...
            <div>
                ...
                <div className="flex justify-between items-center bg-gray-100 p-4 border-t-2">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Link
                            to={`/oncar/car/${car.id}`}
                            className=" flex items-center font-semibold text-sm text-gray-600 border border-gray-600 px-3 py-2 rounded-md hover:bg-gray-600 hover:text-white transition-all">
                            <RiEyeLine />
                        </Link>
